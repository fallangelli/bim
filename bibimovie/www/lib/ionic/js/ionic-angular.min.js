    ...
    function v(e) {
      function n() {
        S.push(o), i(o.show, a, !1), o.responseDeferred.promise.then(function (e) {
          ...
          }, 400, !1), (k._backButtonActionDone || p)()), e
        })
      }

      var o = k._createPopup(e), a = 0;
      return S.length > 0 ? (a = y.stackPushDelay, i(S[S.length - 1].hide, a, !1)) : (r.addClass("popup-open"), t.retain(), k._backButtonActionDone = c.registerBackButtonAction(f, u.popup)), o.responseDeferred.promise.close = function (e) {
      ...
      create: function (t, l, h, T, E, R) {
        var L, M, N, z = ++A, O = {
          init: function (e, t) {
            ...
            function v() {
              p(L, F.shouldAnimate ? "entering" : B), p(M, F.shouldAnimate ? "leaving" : I), F.run(1), r._instances.forEach(function (e) {
            ...
            var U = o.transitions.views[H.transition] || o.transitions.views.none, F = U(L, M, H.direction, H.shouldAnimate && u && R);
            if (F.shouldAnimate && (L.on($, w), L.data(k, e(b, D)), i.show(D)), E && (O.emit("before", H, q), p(L, x), F.run(0)), R && (C = n.defer(), P.push(C.promise)), E && R)e(v, 16); else {
              if (!R)return p(L, "entering"), p(M, "leaving"), {
                run: F.run, cancel: function (t) {
                  t ? (L.on($, y), L.data(k, e(S, D)), i.show(D)) : S(), F.shouldAnimate = t, F.run(0), F = null
                }
              };
              R && v()
            }
    ...
    return {
      restrict: "E", require: ["^ionItem", "^?ionList"], priority: Number.MAX_VALUE, compile: function (t, n) {
        return n.$set("class", (n["class"] || "") + " button icon button-icon", !0),
          t[0].setAttribute("data-prevent-scroll", !0), function (t, n, i, o) {
