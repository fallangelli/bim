...
public class CityareaBaidu {
  ...
  /**
   * This field was generated by MyBatis Generator.
   * This field corresponds to the database column cityarea_baidu.city_name
   *
   * @mbggenerated
   */
  ...
  /**
   * This method was generated by MyBatis Generator.
   * This method returns the value of the database column cityarea_baidu.city_name
   *
   * @return the value of cityarea_baidu.city_name
   * @mbggenerated
   */
  ...
  /**
   * This method was generated by MyBatis Generator.
   * This method sets the value of the database column cityarea_baidu.city_name
   *
   * @param cityName the value for cityarea_baidu.city_name
   * @mbggenerated
   */
